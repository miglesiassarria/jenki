...
public class Messages {
    ...
    /**
     * Key {@code
     * HudsonPrivateSecurityRealm.CreateAccount.UserNameInvalidCharacters}:
     * {@code User name must only contain alphanumeric characters, underscore
     * and dash}.
     * 
     * @return
     *     {@code User name must only contain alphanumeric characters, underscore
    ...
    public static String HudsonPrivateSecurityRealm_CreateAccount_UserNameInvalidCharacters() {
        return holder.format("HudsonPrivateSecurityRealm.CreateAccount.UserNameInvalidCharacters");
    }
    ...
    public static Localizable _HudsonPrivateSecurityRealm_CreateAccount_UserNameInvalidCharacters() {
        return new Localizable(holder, "HudsonPrivateSecurityRealm.CreateAccount.UserNameInvalidCharacters");
    }
    ...
    /**
     * Key {@code
     * HudsonPrivateSecurityRealm.CreateAccount.UserNameInvalidCharactersCustom}:
     * {@code User name must match the following expression: {0}}.
     * 
     * @param arg0
     *      1st format parameter, {@code {0}}, as {@link String#valueOf(Object)}.
     * @return
    ...
    public static String HudsonPrivateSecurityRealm_CreateAccount_UserNameInvalidCharactersCustom(Object arg0) {
        return holder.format("HudsonPrivateSecurityRealm.CreateAccount.UserNameInvalidCharactersCustom", arg0);
    }
     ...
     *     {@code User name must match the following expression: {0}}
     */
    public static Localizable _HudsonPrivateSecurityRealm_CreateAccount_UserNameInvalidCharactersCustom(Object arg0) {
        return new Localizable(holder, "HudsonPrivateSecurityRealm.CreateAccount.UserNameInvalidCharactersCustom", arg0);
    }
