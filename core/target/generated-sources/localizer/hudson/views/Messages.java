...
public class Messages {
    ...
    /**
     * Key {@code LastDurationColumn.DisplayName}: {@code Last Duration}.
     * 
     * @return
     *     {@code Last Duration}
     */
    ...
    /**
     * Key {@code DefaultMyViewsTabsBar.DisplayName}: {@code Default My Views
     * TabBar}.
     * 
     * @return
     *     {@code Default My Views TabBar}
     */
    ...
    /**
     * Key {@code WeatherColumn.DisplayName}: {@code Weather}.
     * 
     * @return
     *     {@code Weather}
     */
    ...
    /**
     * Key {@code GlobalDefaultViewConfiguration.ViewDoesNotExist}: {@code
     * The specified view does not exist: {0}}.
     * 
     * @param arg0
     *      1st format parameter, {@code {0}}, as {@link String#valueOf(Object)}.
     * @return
     *     {@code The specified view does not exist: {0}}
     */
    public static String GlobalDefaultViewConfiguration_ViewDoesNotExist(Object arg0) {
        return holder.format("GlobalDefaultViewConfiguration.ViewDoesNotExist", arg0);
    }
     ...
     *     {@code The specified view does not exist: {0}}
     */
    public static Localizable _GlobalDefaultViewConfiguration_ViewDoesNotExist(Object arg0) {
        return new Localizable(holder, "GlobalDefaultViewConfiguration.ViewDoesNotExist", arg0);
    }

    /**
     * Key {@code BuildButtonColumn.DisplayName}: {@code Build Button}.
     * 
     * @return
     *     {@code Build Button}
     */
    ...
    /**
     * Key {@code LastStableColumn.DisplayName}: {@code Last Stable}.
     * 
     * @return
     *     {@code Last Stable}
     */
    ...
    /**
     * Key {@code LastSuccessColumn.DisplayName}: {@code Last Success}.
     * 
     * @return
     *     {@code Last Success}
     */
    ...
    /**
     * Key {@code DefaultViewsTabsBar.DisplayName}: {@code Default Views
     * TabBar}.
     * 
     * @return
     *     {@code Default Views TabBar}
     */
    ...
    /**
     * Key {@code LastFailureColumn.DisplayName}: {@code Last Failure}.
     * 
     * @return
     *     {@code Last Failure}
     */
    ...
    /**
     * Key {@code StatusColumn.DisplayName}: {@code Status}.
     * 
     * @return
     *     {@code Status}
     */
