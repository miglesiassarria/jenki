...
public class Messages {
    ...
    /**
     * Key {@code ConfigureTools.DisplayName}: {@code Global Tool
     * Configuration}.
     * 
     * @return
     *     {@code Global Tool Configuration}
     */
    ...
    /**
     * Key {@code AdministrativeMonitorsDecorator.DisplayName}: {@code
     * Administrative Monitors Notifier}.
     * 
     * @return
     *     {@code Administrative Monitors Notifier}
     */
    public static String AdministrativeMonitorsDecorator_DisplayName() {
        return holder.format("AdministrativeMonitorsDecorator.DisplayName");
    }
    ...
    public static Localizable _AdministrativeMonitorsDecorator_DisplayName() {
        return new Localizable(holder, "AdministrativeMonitorsDecorator.DisplayName");
    }
    ...
    /**
     * Key {@code ConfigureLink.DisplayName}: {@code Configure System}.
     * 
     * @return
     *     {@code Configure System}
     */
    ...
    /**
     * Key {@code NodesLink.DisplayName}: {@code Manage Nodes}.
     * 
     * @return
     *     {@code Manage Nodes}
     */
    ...
    /**
     * Key {@code PluginsLink.DisplayName}: {@code Manage Plugins}.
     * 
     * @return
     *     {@code Manage Plugins}
     */
